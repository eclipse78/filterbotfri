...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002007174829 -1001927336862 -1001764676038').split()]  # For Multiple Id Use One Space Between Each.
